...
// $products = getProducts($conn, 12, 0, $min_price, $max_price, $brands, $sizes, $colors, $categories);

// End logic phân trang

// Lấy các tiêu chí lọc từ URL
// $filters = [
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <form action="shop.php" method="GET">
                ...
                <div class="bg-light p-4 mb-30">
                    <!-- <form action="shop.php" method="get"> -->
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input" name="color" id="color-all" checked>
                        <label class="custom-control-label" for="price-all">All Color</label>
                        <span class="badge border font-weight-normal">1000</span>
                    </div>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input" name="color" id="color-1">
                        <label class="custom-control-label" for="color-1">Black</label>
                        <span class="badge border font-weight-normal">150</span>
                    </div>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input" name="color" id="color-2">
                        <label class="custom-control-label" for="color-2">Gray</label>
                        <span class="badge border font-weight-normal">295</span>
                    </div>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input" name="color" id="color-3">
                        <label class="custom-control-label" for="color-3">Red</label>
                        <span class="badge border font-weight-normal">246</span>
                    </div>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input" name="color" id="color-4">

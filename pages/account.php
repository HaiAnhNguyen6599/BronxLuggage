                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p><strong>Phone:</strong>
                                    <?= $user['phone'] ? htmlspecialchars($user['phone']) : 'Not provided'; ?></p>
                                <p><strong>Address:</strong>
                                    <?= $user['address'] ? htmlspecialchars($user['address']) : 'Not provided'; ?></p>
                                <p><strong>City:</strong>
                                    <?= $user['city'] ? htmlspecialchars($user['city']) : 'Not provided'; ?></p>

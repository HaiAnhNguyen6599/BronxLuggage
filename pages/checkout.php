                    ...
                    <div class="bg-light p-30 mb-5">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" name="phone" value="<?= htmlspecialchars($user['phone'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Address</label>
                            ...
                            <div class="col-md-6 form-group">
                                <label>City</label>
                                <input class="form-control" type="text" name="city" value="<?= htmlspecialchars($user['city'] ?? '') ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($cart_items as $item): ?>
                                    <div class="d-flex justify-content-between">
                                        <p><?= htmlspecialchars($item['name'] ?? 'Unknown Product') ?> x <?= htmlspecialchars($item['quantity'] ?? 0) ?></p>
                        ...
                        <div class="bg-light p-30">
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="cod" name="payment_method" value="cod" required checked>
                                    <label class="custom-control-label" for="cod">Cash on Delivery</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="bank_transfer" name="payment_method" value="bank_transfer">
                                    <label class="custom-control-label" for="bank_transfer">Bank Transfer</label>
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="credit_card" name="payment_method" value="credit_card">
                                    <label class="custom-control-label" for="credit_card">Credit Card</label>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-block btn-primary font-weight-bold py-3" <?php echo empty($cart_items) ? 'disabled' : ''; ?>>Place Order</button>
                        </div>
                    </div>
                </div>
            </div>

...
<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
  <div class="row px-xl-5 pt-5">
    <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
      ...
      <p class="mb-2">
        <i class="fa fa-map-marker-alt text-primary mr-3"></i>19 Le Thanh Nghi, Ha Noi, Viet Nam
      </p>
      <p class="mb-2">
        <i class="fa fa-envelope text-primary mr-3"></i>bronxluggage@example.com
      </p>
      <p class="mb-0">
      ...
      <div class="row">
        <div class="col-md-4 mb-5">
          ...
          <div class="d-flex flex-column justify-content-start">
            <a class="text-secondary mb-2" href="../pages/index.php"><i class="fa fa-angle-right mr-2"></i>Home</a>
            <a class="text-secondary mb-2" href="../pages/shop.php"><i class="fa fa-angle-right mr-2"></i>Our Shop</a>
